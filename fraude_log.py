...
# Função para logar os detalhes da compra e o resultado
def log_prediction(details, result, score):
    logging.info(f'Detalhes da compra: {details}')
    logging.info(f'Resultado da predição: {result}')
    logging.info(f'Score do resultado: {score}%')
...
if st.button('VERIFICAR FRAUDE'):
    ...
    # Logar os detalhes da compra e o resultado
    log_prediction(data, resultado, score)
